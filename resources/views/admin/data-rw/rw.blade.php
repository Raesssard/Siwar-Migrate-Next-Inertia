                                                    ...
                                                    <div class="modal-content shadow-lg">
                                                        ...
                                                        <form action="{{ route('admin.rw.update', $data->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="nomor_rw{{ $data->id }}" class="form-label">Nomor RW</label>
                                                                    <input type="text" class="form-control"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="nama_ketua_rw{{ $data->id }}" class="form-label">Nama Ketua RW</label>
                                                                    <input type="text" class="form-control"
                                                                        name="nama_ketua_rw"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="mulai_menjabat{{ $data->id }}" class="form-label">Mulai Masa Jabatan</label>
                                                                    <input type="date" name="mulai_menjabat"
                                                                        id="mulai_menjabat{{ $data->id }}" required
                                                                        value="{{ $data->mulai_menjabat }}"
                                                                        class="form-control">
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label for="akhir_jabatan{{ $data->id }}" class="form-label">Akhir Masa Jabatan</label>
                                                                    <input type="date" name="akhir_jabatan"
                                                                        id="akhir_jabatan{{ $data->id }}" required
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content shadow-lg">
                                    <div class="modal-header bg-primary text-white">
                                        <h5 class="modal-title" id="modalTambahRWLabel">Tambah Data RW</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.rw.store') }}" method="POST" class="p-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_ketua_rw" id="nama_ketua_rw" maxlength="50"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="mulai_menjabat" id="mulai_menjabat"
                                                    value="{{ old('mulai_menjabat') }}" required
