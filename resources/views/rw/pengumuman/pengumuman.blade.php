            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-7">
                    <div class="card shadow mb-4">
                                ...
                                <table class="table table-sm scroll-table text-nowrap table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($pengumuman as $data)
                                            ...
                                            @include('rw.pengumuman.komponen.modal_edit_pengumuman')
                                            <!-- Modal Edit Pengumuman End -->

                                            <!-- Modal Detail Pengumuman -->
                                            @include('rw.pengumuman.komponen.modal_detail_pengumuman')
                                            <!-- Modal Detail Pengumuman End -->
                                        @endforeach
                        ...
                        @include('rw.pengumuman.komponen.modal_tambah_pengumuman')
